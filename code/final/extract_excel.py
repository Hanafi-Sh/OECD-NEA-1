...
def extract_excel_data(filepath, header_row_count=1):
    ...
    Args:
        ...
        header_row_count (int): Number of rows expected to form the header (default is 1).
